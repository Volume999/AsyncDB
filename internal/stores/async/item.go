...
func (i *ItemStore) Put(ctx *pocsdb.ConnectionContext, value models.Item) <-chan databases.RequestResult {
	return i.db.Put(ctx, models.Item{}, models.ItemPK{Id: value.Id}, value)
}

func (i *ItemStore) Get(ctx *pocsdb.ConnectionContext, key models.ItemPK) <-chan databases.RequestResult {
	return i.db.Get(ctx, models.Item{}, key)
}

func (i *ItemStore) Delete(ctx *pocsdb.ConnectionContext, key models.ItemPK) <-chan databases.RequestResult {

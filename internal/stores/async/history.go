...
func (i *HistoryStore) Put(ctx *databases.ConnectionContext, value models.History) <-chan databases.RequestResult {
	// History is not used in the benchmark, and it does not have a primary key
	panic("implement me")
}

func (i *HistoryStore) Get(ctx *databases.ConnectionContext, key models.HistoryPK) <-chan databases.RequestResult {
	return i.db.Get(ctx, models.Item{}, key)
}

func (i *HistoryStore) Delete(ctx *databases.ConnectionContext, key models.HistoryPK) <-chan databases.RequestResult {
